...
\moveleft2.425\hoffset\centerline{\textsc{\large Arya D. McCarthy}} % Your name at the top
 \vspace{-0.5em}
...
\noindent
\begin{minipage}{0.70339887\textwidth}
...
\begin{minipage}{0.2819660113\textwidth}
  \begin{description}[noitemsep]
  \item Phone: \href{tel:+14698343984}{\textsc{(469) 834-3984}}
  \item \href{mailto:arya@jhu.edu}{arya@jhu.edu}
  \item \href{https://cs.jhu.edu/~arya}{cs.jhu.edu/{\raise.17ex\hbox{$\scriptstyle\mathtt{\sim}$}}arya}
  \end{description}
\end{minipage}
...
\item Conference reviewer, EMNLP (2018 secondary)
\item Webmaster, \href{https://sigmorphon.github.io}{ACL SIGMORPHON}
\item Webmaster, \href{https://unimorph.github.io}{Universal Morphology project (UniMorph)}
\item Webmaster, \href{http://ubicomp.lyle.smu.edu}{SMU Ubiquitous Computing Lab} (2016--2017)
...
\item Contributor to \texttt{PyTorch} open-source library
\item Contributor to \texttt{PyTorch/tutorials} open-source library
\end{itemize}
